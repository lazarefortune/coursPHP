<?php
  session_start();
  // On teste si l'utilisateur existe et est connecté
  ...
  <main class="container">
    ...
    <div class="mt-4">
      <div class="row d-flex justify-content-center">
        <div class="col-md-9">
          <form class="mt-4 needs-validation" method="post" action="actions/edit.php">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="login" aria-describedby="loginHelp" name="login" value="<?= $_SESSION['login'] ?>" disabled>
              <div id="loginHelp" class="form-text">L'identifiant n'est pas modifiable</div>
            </div>
            <div class="mb-3">
              <label for="password" class="form-label">Password</label>
              <input type="password" class="form-control" id="password" aria-describedby="passwordHelp" name="password">
              <div id="passwordHelp" class="form-text">Veuillez saisir un nouveau mot de passe pour le modifier</div>
            </div>
            <button type="submit" class="btn btn-success" name="registerForm2">Mettre à jour</button>
          </form>
        </div>
      </div>
    </div>
