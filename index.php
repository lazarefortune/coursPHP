...
<html lang="fr">
  ...
  <nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">Gestion-IUT</a>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdown01">
              <li><a class="dropdown-item" href="edit.php">Editer le profil</a></li>
  ...
  <main class="container">
    ...
    <div class="starter-template text-center py-5 px-3">
      <h1>Bienvenue sur le site de gestion des étudiants</h1>
      <p class="lead">Nous allons gérer les etudiants, les promotions, et les notes</p>
    </div>
